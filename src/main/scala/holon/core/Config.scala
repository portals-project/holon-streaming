...
object Config {
  ...
  final val WORK_STEALING_THRESHOLD = 100000   // was 10!! Determines how many (empty) polls a node should perform before it starts work stealing.
  var WORK_STEAL_ATTEMPT_COOLDOWN = 2000 // How long to wait before trying to steal work again.
  var HEARTBEAT_INTERVAL = 500L
  var FAILURE_DETECTION_THRESHOLD = 2_0000000L // was 2000L
  ...
  var WORKLOAD: Int = sys.env.get("WORKLOAD").map(_.toInt).getOrElse(4) // 0 = Q0, 4 = Q4, 7 = Q7
