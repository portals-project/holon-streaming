...
object LagManager {
    ...
    private val lagPerNode = mutable.Map.empty[Int, Long]
     ...
     */
    def getPartitionWithMaxLag(consumerPerPartition: mutable.Map[Int, (Byte, LogConsumer)]): Option[(Int, Long)] = {
    ...
    def calculateCurrentLagIfRequired(consumerPerPartition: mutable.Map[Int, (Byte, LogConsumer)]): Unit = {
    ...
    private def calculateCurrentLag(consumerPerPartition: mutable.Map[Int, (Byte, LogConsumer)]): Unit = {
