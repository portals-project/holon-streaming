package holon.streaming.checkpointing
...
abstract class CheckpointManager {
     ...
     */
    def createCheckpointIfRequired(nodeId: Int, procFunctionPerPartition: scala.collection.mutable.Map[Int, holon.streaming.processing.ProcFun],
     ...
     */
    def createCheckpointForPartition(nodeId: Int, partitionId: Int, procFun: holon.streaming.processing.ProcFun, consumer: LogConsumer): Unit = {
     ...
     */
    private def createPartitionCheckpointContent(procFun: holon.streaming.processing.ProcFun) : String = {
    ...
    def recoverPartitionCheckpoints(nodeId: Int, partitionIds: List[Int],
                                procFunctionPerPartition: scala.collection.mutable.Map[Int, holon.streaming.processing.ProcFun],
                                consumerPerPartition: scala.collection.mutable.Map[Int, (Byte, LogConsumer)]): Unit
     ...
     */
    protected def restorePartitionSnapshot(partitionId: Int, offset: Long, snapshot: String, procFun: holon.streaming.processing.ProcFun, consumer: LogConsumer): Unit = {
     ...
     */
    def recoverCheckpointForPartition(partitionId: Int, procFun: holon.streaming.processing.ProcFun, consumer: LogConsumer): Unit
