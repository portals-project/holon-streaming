...
import holon.utils.*
import holon.streaming.cloud.GCSClient.bucketName
import holon.streaming.cloud.GCSClient
import holon.streaming.messaging.messages.Checkpoint
import holon.core.Config.CHN_CONTROL
import upickle.default.writeBinary

import scala.collection.immutable.Map

class CloudStorageCheckpointManager(outputCollector: holon.streaming.output.OutputCollector) extends CheckpointManager {
